...
#if !defined(CONFIG_H3CTX180X) && !defined(CONFIG_AX18T) && !defined(CONFIG_Q20) && !defined(CONFIG_A9) && !defined(CONFIG_C3N) && !defined(CONFIG_RM2100) && !defined(CONFIG_CR660X) && !defined(CONFIG_BZV)
...
void PWR_LEDON(void)
{
#if defined(CONFIG_RTAX53U) || defined(CONFIG_RTAX54) || defined(CONFIG_H3CTX180X) || defined(CONFIG_XG1) || defined(CONFIG_AX18T) || defined(CONFIG_Q20) || defined(CONFIG_A9) || defined(CONFIG_C3N) || defined(CONFIG_RM2100) || defined(CONFIG_CR660X) || defined(CONFIG_BZV)
	gpio_output(PWR_LED,0);
