...
#if defined(CONFIG_RTAX53U) || defined(CONFIG_4GAX56) || defined(CONFIG_RTAX54) || defined(CONFIG_XD4S) || defined(CONFIG_H3CTX180X) || defined(CONFIG_XG1) || defined(CONFIG_AX18T)
